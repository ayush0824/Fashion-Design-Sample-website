    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 950px;
        ...
        <div class="slider">	<!--slider-->
	        <div class="sliderleft">
				...
				<p class="pslider">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer non ante eget nibh tincidunt consequat. Donec nec aliquet nulla. Pellentesque ut viverra lacus.</p>
			</div>
			<div class="sliderright" u="slides" >
    			<?php
                while ($fetch=mysqli_fetch_array($exe,MYSQLI_ASSOC)) 
                {
                ?>

            	<a u=image href="#"> <img src="slider_image/<?php echo $fetch['slimg'];?>"  width="100%" height="100%" alt="Slider Image"></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                    <?php echo $fetch['sltitle'];  ?>
                </div>  
        ...
        <style>/* jssor slider bullet navigator skin 01 css */
            /*
            .jssorb01 div           (normal)
